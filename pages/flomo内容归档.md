...
- [[Zettelkasten本质上是一种渐进式总结方法]] [ref](https://blog.jimmylv.info/2020-06-03-zettelkasten-in-action/) #卡片盒写作法 #学习技巧
...
- 在重点知识的反复重复与关联中能不断挖掘出新东西，不断的强化基础太重要了 #灵感 #学习技巧
- 通过不断增强的成就感，来激发学习的惯性 #学习技巧
	- 先学会如何学习，再研究如何[[培养习惯]]。
...
- [字节二面：如何实现二维码扫码登录？问倒一大片。。-哔哩哔哩](https://b23.tv/PjAwtDP) #系统设计 #card
  ...
  id:: 64947d2d-4b1c-44ca-9b54-2c46e8b716e4
	- ![image.png](../assets/image_1687454068042_0.png){:height 331, :width 521}
	- 已扫码，待确认：我是谁
	- 已确认：我是我
		- 下图里的临时token只能使用一次，保证扫码和确认登陆来自同一个设备
	- ![image.png](../assets/image_1687577950427_0.png)
...
- 小学，初中，知识点少，不看笔记，单纯靠脑力记忆就能基本完成学习任务。知识量少，就有机会通过做一定量的习题形成长久记忆，考个好分数。
  ...
  记忆往往是模糊的，断层的，面对稍有生疏的旧知识，估计短时间内靠脑力只能重新把之前做过的推导和总结重走一遍，这就是原地踏步，边学边忘，知识理解始终处于低级阶段，无法应对更复杂的问题。如果有了好的笔记输出，即使记忆模糊，也能快速回顾笔记，在之前精妙的理解上继续积累更高级的知识理解，这样能够规避题海战术。 #个人思考 #学习技巧 #应试学习法
...
- [[卡片盒写作法]]和[[思维导图]]，都是尽量不设边界 #方法 #个人思考
	- [[卡片盒不设内容边界，不对内容强行分类]]
...
- 回顾对书的划线，也要同时回顾一下上下文，这样才能用自己的语言转换成有效的文献笔记 #卡片盒写作法
- 还是听每日英语听力更舒服，短小的音频，先精听，再看文本，再精听 #外语学习 #学习技巧
...
- 笔记驱动，而不是博客驱动。自我命题的博客，带来的是紧张的时间，匆忙的阅读和拷贝，知识孤立，写后就忘。 #PKM ((64948909-925c-4bb0-9abb-e21435ff7b70))
...
- 学[[语法]]应该先搞清楚整体框架，然后再去试图记住特例的细枝末节 #外语学习 #学习技巧
