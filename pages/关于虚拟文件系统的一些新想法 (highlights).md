title:: 关于虚拟文件系统的一些新想法 (highlights)
author:: [[云风的 BLOG]]
full-title:: "关于虚拟文件系统的一些新想法"
category:: #articles
url:: https://blog.codingnow.com/2024/02/vfs_plan.html
summary:: 虚拟文件系统 (vfs) 是 Ant 引擎的核心模块。在 wiki 上有介绍 ，blog 上也有总结。
...
- Highlights first synced by [[Readwise]] [[Mar 7th, 2024]]
	- 在运行时，需要不断的对 vfs 进行增改。把空的根目录扩展出更多的文件。我们可以设置一个路径 path 为一个特定的 hash 值。如果这个 path 中的任意一个子目录不存在，都应该被立刻创 ([View Highlight](https://read.readwise.io/read/01hr83f665ef9wq46n4ha13ck4))