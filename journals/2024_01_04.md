...
- [[OpenKruise]]的原地升级功能 功能参考[src](https://openkruise.io/zh/docs/core-concepts/inplace-update/) #card
  id:: 6596788c-b7a0-484f-97be-2012317f5843
	...
	- 第1种情况，如果是statefulset，k8s会删除旧pod，创建新pod，而kruise只是修改pod信息
	- 第2种情况是通过修改pod的image字段实现
	- 第3种情况是通过修改pod的labels/anntations，并且重建容器，保证容器能接收到新的labels/anntations
		- 💡验证了一下普通的statefulset，如果容器使用了env from，修改对应的labels，容器是否会重启
			- {{embed ((65b67a39-70a7-472b-a56a-e34009cada19))}}
	...
	- kubelet支持容器镜像原地升级的流程图 [如何在Kubernetes中实现容器原地升级-腾讯云开发者社区-腾讯云 (tencent.com)](https://cloud.tencent.com/developer/article/1413743)
	   ![image.png](../assets/image_1704436719595_0.png)