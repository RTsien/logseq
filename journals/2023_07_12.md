- 页表如何存储 #card #《x86的分页机制和Linux实现》 #linux内存管理机制
  id:: 64ae1b90-b13d-4c44-a045-a6716c1f43ba
	- 进程未执行时，[[页表]]的始址和页表长度放在[[进程控制块]]（PCB，代码对应struct task_struct​）中，当进程被调度时，操作系统内核会把它们放到[[页表寄存器]]： {{embed ((65afa2e5-4287-4d54-a75d-c1433ae4283e))}}
...
- [[redis]]如何避免[[大key]] #card
  id:: 64ae2ce8-6c23-46cd-a3f0-5ee9633e97e0
	- {{embed ((64ad0c23-bf5a-4276-bbdf-2efa0eb590aa))}}
...
- [[redis]]如何查找[[大key]] #card #小林coding
  ...
  card-last-reviewed:: 2025-03-22T19:52:05.710Z
  card-last-score:: 1
	- {{embed ((64ad0c23-bf5a-4276-bbdf-2efa0eb590aa))}}
	- bigkeys
		- ```
