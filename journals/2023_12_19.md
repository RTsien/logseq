- [xyproto/algernon: Small self-contained pure-Go web server with Lua, Teal, Markdown, HTTP/2, QUIC, Redis and PostgreSQL support (github.com)](https://github.com/xyproto/algernon) #开源项目 go webserver集成lua
- [jetpack-io/devbox: Instant, easy, and predictable development environments (github.com)](https://github.com/jetpack-io/devbox) #开源项目 基于[[NIX]]的命令行环境管理工具
- 获取[[golang]]运行时的统计信息 [src](https://github.com/sohaha/zlsgo/blob/master/zpprof/systeminfo.go) #zlsgo
	- ```golang
